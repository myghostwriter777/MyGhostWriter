...
const PriBtn=({children,onClick,loading,disabled,fullWidth=true,variant="blue"})=>{
  ...
  return <button onClick={onClick} disabled={loading||disabled} onMouseEnter={()=>setHover(true)} onMouseLeave={()=>setHover(false)} style={{width:fullWidth?"100%":"auto",padding:"12px 20px",borderRadius:8,border:"none",background:bg,color:loading||disabled?C.muted:"#000",fontSize:14,fontWeight:800,cursor:loading||disabled?"not-allowed":"pointer",transition:"all 0.2s",display:"flex",alignItems:"center",justifyContent:"center",gap:8,transform:active&&hover?"translateY(-1px)":"none",boxShadow:loading||disabled?"none":variant==="violet"?(active&&hover?"0 6px 26px rgba(155,127,232,0.45)":"0 4px 20px rgba(155,127,232,0.3)"):(active&&hover?`0 6px 26px ${C.blueGlow}`:`0 4px 20px ${C.blueGlow}`),fontFamily:"inherit",letterSpacing:"0.01em"}}>{loading?<><Spin/> Processing...</>:children}</button>;
};
...
const CARD_IMG={
  ...
  story:"data:image/jpeg;base64,",
...
function HumanizeMode({user}){
  ...
  return(
    <div>
      ...
      <button onClick={process} disabled={isLoading||!text.trim()} onMouseEnter={()=>setHzHover(true)} onMouseLeave={()=>setHzHover(false)} style={{width:"100%",padding:"13px",borderRadius:8,border:"none",background:isLoading||!text.trim()?"#0c1220":"linear-gradient(135deg,#9b7fe8,#c4b5fd)",color:isLoading||!text.trim()?C.muted:"#000",fontSize:14,fontWeight:800,cursor:isLoading||!text.trim()?"not-allowed":"pointer",fontFamily:"inherit",display:"flex",alignItems:"center",justifyContent:"center",gap:9,transition:"all 0.2s",transform:!isLoading&&text.trim()&&hzHover?"translateY(-1px)":"none",boxShadow:isLoading||!text.trim()?"none":hzHover?"0 6px 26px rgba(155,127,232,0.45)":"0 4px 20px rgba(155,127,232,0.3)"}}>
